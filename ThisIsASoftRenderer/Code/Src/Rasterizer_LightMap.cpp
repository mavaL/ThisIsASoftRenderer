...
{
	///////////////////////////////////////////////////////////////////////////////////////////
	void RasLightMap::_RasterizeTriangle( const SVertex& vert0, const SVertex& vert1, const SVertex& vert2, const SFace& face, const SRenderContext& context )
	{
		RenderUtil::DrawTriangle_Scanline_V2(&vert0, &vert1, &vert2, context);
	}

	void RasLightMap::LerpVertexAttributes( SVertex* dest, const SVertex* src1, const SVertex* src2, float t, eLerpType type )
	{
	...
	void RasLightMap::RasTriangleSetup( SScanLinesData& rasData, const SVertex* v0, const SVertex* v1, const SVertex* v2, eTriangleShape type )
	{
	...
	void RasLightMap::RasLineSetup( SScanLine& scanLine, const SScanLinesData& rasData )
	{
	...
	void RasLightMap::RaterizeAdvancePixel( SScanLine& scanLine )
	{
		Common::Add_Vec2_By_Vec2(scanLine.curUV, scanLine.curUV, scanLine.deltaUV);
	}

	void RasLightMap::RaterizeAdvanceLine( SScanLinesData& scanLineData )
	{
